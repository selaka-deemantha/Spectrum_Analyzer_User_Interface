...
void MainWindow::updateCursorLabels()
{
    ...
    cursorPanel->updateH1(ui->plotWidget->getHCursor1Value());
    cursorPanel->updateH2(ui->plotWidget->getHCursor2Value());
    cursorPanel->updateV1(ui->plotWidget->getVCursor1Freq());
    cursorPanel->updateV2(ui->plotWidget->getVCursor2Freq());
}
