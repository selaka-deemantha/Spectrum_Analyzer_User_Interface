...
//    DisplayMethod getDisplayMode() const;
    ...
    void setPreAmp(bool number);
    void setSweepDelay (int number);
    ...
    float getHCursor1Pos() const;
    float getHCursor2Pos() const;
    float getVCursor1Pos() const;
    float getVCursor2Pos() const;


    float getVCursor1Freq() const;
    float getVCursor2Freq() const;
    float getHCursor1Value() const;
    float getHCursor2Value() const;
...
public slots:
    ...
    void setHCursor1Enabled(bool en);
    void setHCursor2Enabled(bool en);
    void setVCursor1Enabled(bool en);
    void setVCursor2Enabled(bool en);

    void moveHCursor1(float val);
    void moveHCursor2(float val);
    void moveVCursor1(float val);
    void moveVCursor2(float val);
...
private:
    inline static const std::vector<float> correctionValues = {
        14.96f, 13.03f, 11.58f,  8.86f,  7.19f,  6.72f,  5.56f,  4.95f,  6.07f,  8.21f, 10.01f,
        12.12f, 14.07f, 13.78f, 13.02f, 11.19f, 11.45f, 13.23f, 12.35f,  7.90f,  4.49f,
         3.10f,  3.63f,  5.42f,  3.90f,  0.25f, -1.60f, -3.23f, -2.40f, -4.45f, -7.55f
    };
...
//    QVector<int> data;    // stores y-values
    ...
    bool hCursor1Enabled = false;
    bool hCursor2Enabled = false;
    bool vCursor1Enabled = false;
    bool vCursor2Enabled = false;
    ...
    void drawCursors(QPainter &painter, float leftMargin, float w, float h);

    float visibleStartFreq =  0.0f;
    float visibleEndFreq = 0.0f;

signals:
    // This is the missing declaration causing your error
    void frameProcessed();
    void sweepDelaySet(int delay);
    void peaksUpdated(const QList<float>& peakValues, const QList<float>& peakAmplitudes);
    void fftBoundsChanged(int lower, int upper);
    void cursorPositionsUpdated();
};
