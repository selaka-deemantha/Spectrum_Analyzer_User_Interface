...
//    qDebug() << fft_lower << fft_upper << "yoooooooooooo";
...
//        int32_t val = static_cast<int32_t>(raw_buf[i]);
//        fft[i] = val;
//    }
...
//    if (fileCounter < 100) {
//            QString filename = QString("fft_export_%1.txt").arg(fileCounter); // Absolute path recommended for embedded Linux
//            QFile file(filename);

//            if (file.open(QIODevice::WriteOnly | QIODevice::Text)) {
//                QTextStream out(&file);

//                // Save all 1024 points
//                for (int i = 0; i < fft_points; ++i) {
//                    out << fft[i] << "\n";
//                }
