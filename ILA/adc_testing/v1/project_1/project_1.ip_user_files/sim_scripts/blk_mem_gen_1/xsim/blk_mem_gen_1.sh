...
#
# Script generated by Vivado on Mon Jan 26 23:37:01 +0530 2026
...
export RDI_DATADIR="/tools/Vivado_2024_2/Vivado/2024.2/data"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L blk_mem_gen_v8_4_9 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot blk_mem_gen_1 xil_defaultlib.blk_mem_gen_1 xil_defaultlib.glbl -log elaborate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/tools/Vivado_2024_2/Vivado/2024.2/data/xsim"
  fi
